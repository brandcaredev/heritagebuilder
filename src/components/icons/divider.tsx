...
function Divider() {
  const svgWidth = 14; // Fixed width of the SVG content
  const arrowHeight = 25.25; // Fixed height of the arrows
  const circleHeight = 12.7; // Fixed height of the circle

  return (
    <div
      style={{ position: "relative", width: `${svgWidth}px`, height: "100%" }}
    >
      {/* Top Arrow */}
      <svg
        width={svgWidth}
